...
import ManageItemsListComponentFromApi from './subcomponents/ManageItemsListComponentFromApi';

interface ApiBuilderModalComponentProps {
  openDialog: boolean,
...
const ApiBuilderModalComponent: FunctionComponent<ApiBuilderModalComponentProps> = (props) => {
    ...
    <>
      ...
      >
        ...
        <DialogContent>
                ...
                <ManageItemsListComponentFromApi handleFormSubmit={handleFormSubmit} setApiItemData={props.setApiItemData} setisSetApiItemData={props.setisSetApiItemData}/>
...
export default ApiBuilderModalComponent;